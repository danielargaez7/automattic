...
<!-- wp:paragraph {"align":"center","fontSize":"medium","textColor":"contrast"} -->
<p class="has-text-align-center has-contrast-color has-text-color has-medium-font-size"><?php echo esc_html_x( 'Join thousands of satisfied users and take the next step today.', 'CTA description', '${slug}' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons">
  <!-- wp:button {"backgroundColor":"contrast","textColor":"accent"} -->
  <div class="wp-block-button"><a class="wp-block-button__link has-contrast-background-color has-accent-color has-text-color has-background wp-element-button"><?php echo esc_html_x( 'Start Now', 'CTA button', '${slug}' ); ?></a></div>
  <!-- /wp:button -->
</div>
<!-- /wp:buttons -->
